<template>
  <div class="card p-5 flex items-start gap-4 hover:shadow-md transition-shadow duration-200">
    ...
    <div class="min-w-0">
      ...
      <p v-if="sub" class="text-xs text-gray-400 dark:text-gray-500 mt-0.5">{{ sub }}</p>
    </div>
  </div>
</template>
